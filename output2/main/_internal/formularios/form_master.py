...
from formularios.form_caja import FormularioCaja
...
class FormularioMaster(tk.Tk):
    def __init__(self):
        ...
        perfil_path = obtener_ruta_imagen("imgs/user.png")
        
        # Aquí asumo que util_img.read_image es una función que carga la imagen
        self.logo = util_img.read_image(logo_path, (560, 560))
        self.perfil = util_img.read_image(perfil_path, (100, 100))
    ...
    def control_sidebar(self):
        ...
        buttons_info = [
            ...
            ("          Caja", self.buttonCaja, self.openCaja),
            ("          Agenda de Pedidos", self.buttonPedidos, self.openPedidos),
            ("          Historial de Ventas", self.buttonVentas, self.openVentas),
    ...
    def openCaja(self):
        self.limpiar_panel(self.cuerpo_principal)
        FormularioCaja(self.cuerpo_principal)
