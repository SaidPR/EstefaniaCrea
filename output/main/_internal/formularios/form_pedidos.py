...
class FormularioPedidos:
    def __init__(self, panel_principal):
        ...
        etTitulo = Label(panel_principal, text="Agenda de Pedidos", fg="black", bg="white", font=("Playfair Display", 30, "bold"))
        ...
        tabla = ttk.Treeview(
            tabla_frame,
            columns=("Id_Pedido", "Cliente", "Contacto", "Producto", "Cantidad", "Monto_total", "Metodo_de_pago", "Fecha", "Hora", "Lugar_de_entrega", "Estatus", "Anticipo"),
            show="headings",
        ...
        tabla.heading("Contacto", text="Teléfono")
        ...
        tabla.heading("Anticipo", text="Anticipo")
        ...
        tabla.column("Metodo_de_pago", width=130, anchor="center")
        ...
        tabla.column("Anticipo", width=70, anchor="center")
    ...
    def obtener_pedidos(self):
        ...
        if conn:
            cursor = conn.cursor()
            cursor.execute("SELECT Id_Pedido, Cliente, Contacto, Producto, Cantidad, Monto_total, Metodo_de_pago, Fecha, Hora, Lugar_de_entrega, Estatus, Anticipo FROM Pedidos")
                ...
                if confirmacion:
                    try:
                        ...
                        """, (
                            ...
                            "Vendido",  # Estatus
                            pedido[5], # Anticipo
                            "0.00"  # Cambio (Monto_total - Anticipo)
                        ))
